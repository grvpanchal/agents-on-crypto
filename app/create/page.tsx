...
import { Image as ImageIcon, Upload, AlertTriangle, Info } from "lucide-react";
    ...
    const onSubmit = async (values: z.infer<typeof formSchema>) => {
        ...
        dispatch(
            uploadNFT({
                ...
                creatorImage: "/images/default-creator.png",
                owner: address || "",
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormDescription>
                                            The description will be displayed on
                                            the NFT&apos;s detail page.
                                        </FormDescription>
                                        <FormMessage />
                                    </FormItem>
                                )}
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormDescription>
                                                Percentage of sales you&apos;ll
                                                receive when someone resells
                                                your NFT.
                                            </FormDescription>
                                            <FormMessage />
                                        </FormItem>
                            ...
                            <div className="bg-muted/60 p-4 rounded-lg flex items-start space-x-3 mb-4">
                                ...
                                <div className="text-sm">
                                    ...
                                    <p className="text-muted-foreground">
                                        Minting an NFT will require a gas fee
                                        for the blockchain transaction. Make
